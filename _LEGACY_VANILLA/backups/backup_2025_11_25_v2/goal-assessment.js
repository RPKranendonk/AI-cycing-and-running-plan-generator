...
function assessMarathonGoal(goalTimeStr, raceDateStr) {
    ...
    try {
        ...
        if (result.difficulty === "Elite") {
            result.warnings.push(`⚠️ A sub-${goalTimeStr} is an elite standard. To reach this safely, you must be willing to train at least ${result.minDays}-6 times per week.`);
            ...
            result.warnings.push(`💡 To achieve this comfortably, you will need to commit to training at least ${result.minDays} times per week.`);
        }
