...
5. Warmup/Cooldown Standard (CRITICAL):
   - ALL warmups and cooldowns MUST use 10-minute blocks
   - If more time needed, use multiple 10m or 5m blocks (e.g., 15m = 10m + 5m, 20m = 10m + 10m)
   - This ensures consistency with the rules in prompt-builder.js
`;
