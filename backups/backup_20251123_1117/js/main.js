    ...
    if (state.generatedPlan && state.generatedPlan.length > 0) {
        ...
        blocks.forEach((blockWeeks, blockIndex) => {
            ...
            sidebar.innerHTML = `
                ...
                <div class="text-[10px] text-slate-500 mt-1">${blockWeeks.length} Weeks</div>
            `;
            ...
            weeksContainer.className = 'flex-1 space-y-2';
                    ...
                    <div class="flex justify-between items-center cursor-pointer" id="week-header-${week.week - 1}">
                        ...
                        <div class="text-right flex items-center gap-4">
                            <div class="hidden sm:block text-right">
                                <div class="text-[10px] text-slate-400">Long Run</div>
                                <div class="text-sm font-mono text-slate-300">${week.longRun}</div>
                            </div>
                            <div class="text-right pl-2 border-l border-slate-700">
                                <div class="text-xl font-bold text-white font-mono">${week.mileage}</div>
